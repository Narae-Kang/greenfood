...
//           //calendar 날짜표시
    ...
    font-size: 0.9em;}
       ...
       table.calendar{     width: 1024px; display: inline-table; text-align: left;}
        ...
        .cal-schedule{    font-size: 0.85em; line-height: 20px; height: 110px;}
        ...
        .consist-info{width: 25%;     padding-left: 20px;}
        ...
        .consist-title1-grandson{width: 1024px; text-align: left; height: 50px; line-height: 50px; font-size: 1.25em;}
          ...
          .consist-abstract-box{    width: 100%; height: 195px;}
...
<body>
    <SCRIPT>
        ...
        function cal(value) {
                ...
                if (selected.value == '그린덮밥 10일권') {
                    calcTotalPrice = Math.round(4 * 275000 / 10);
                } else if (selected.value == '그린덮밥 20일권') {
                    calcTotalPrice = Math.round(5 * 440000 / 10);
                } else if (selected.value == '그린덮밥 30일권') {
                    calcTotalPrice = Math.round(6 * 550000 / 10);
                }
                var quantity = document.querySelector("#quantity"); 
                if (selected.value == '그린덮밥 10일권') {
                    calcTotalPrice2 = Math.round(4 * 275000 / 10) * quantity.value;
                } else if (selected.value == '그린덮밥 20일권') {
                    calcTotalPrice2 = Math.round(5 * 440000 / 10) *  quantity.value;
                } else if (selected.value == '그린덮밥 30일권') {
                    calcTotalPrice2 = Math.round(6 * 550000 / 10) * quantity.value;
                }                    
    ...
    function init2(){
      ...
      //바로 주문하기
        ...
        e.preventDefault();
     		let frm = document.forms['greenRice'];
     		//1)'원' 제거
 ...
 <div class="headerList">
    ...
    <div class="List-wrapper">
      <div class="container">
        <div class="wrapper">
          <div class="home-menu">
          <a href="<c:url value='/' />"><i class="fas fa-home"></i>HOME</a> > <a href="${pageContext.request.contextPath }/product/list">맛있는 한끼</a> > <a href="${pageContext.request.contextPath }/product/greenRice/4">그린덮밥</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="List-wrapper2">
      <div class="itemList">
        ...
        <div class="main-image"><img src="<c:url value="/resources/img/rice.jpg"/>" width="550px" height="505px" alt="">
        </div>
        <form 		 id="greenRice"
   ...
   <div class="calendar-container">
      ...
      <div id="cal_tab" class="cal">
      	<table class="calendar">
              ...
              <tr height="130">        
<%--               		<h1>day:${listRice.get(0).mdate.day}</h1> --%>
              		<c:forEach begin="2" end="${listRice.get(0).mdate.day}">
              			<td></td>
              		</c:forEach>         
                  <c:forEach var="rice" items="${listRice}" varStatus="status">
                  <fmt:formatDate value="${rice.mdate}" pattern="yyyy-MM-dd" var="mdate" />
                  <fmt:formatDate value="${rice.mdate}" pattern="d" var="day" />
                  <fmt:parseDate var="mdate" value="${rice.mdate}" pattern="yyyy-MM-dd" />
                  ...
                  <div class="cal-schedule">
								<c:if test="${rice.mdate == mdate}">                      
                  <strong id="maindish-title"> ${rice.maindish}</strong><br>
                  ${rice.salad}<br>
                  ${rice.side_side}<br>
                                    칼로리 : ${rice.cal}kcal<br>
                  </c:if> 
                  </div>
                  </td>
    ...
    <div class="consist-box-biggest">
      <div class="consist-box-bigger">
        <div class="consist-box">
          <div class="consist-image-box"><img src="<c:url value="/resources/img/menuR1.jpg"/>" width="760px" height="460px" alt=""></div>
          <div class="consist-info">
            <div class="consist-abstract-box"></div>
            <div class="consist-of-menu">
              <div class="font-strong">메인요리</div>
              <div class="font-small"> (280~300g) </div>
            </div>
            <div class="consist-of-menu">
              <div class="font-strong">잡곡밥</div>
              <div class="font-small"> (210g 내외) </div>
            </div>
            <div class="consist-of-menu">
              <div class="font-strong">샐러드</div>
              <div class="font-small"> (35~40g) </div>
            </div>
            <div class="consist-of-menu">
              <div class="font-strong">반찬</div>
              <div class="font-small"> 1종(300~320g) </div>
            </div>
      ...
      <div class="rice-wrapper">
          <div class="rice-img-inner">
            <img src="<c:url value="/resources/img/greenrice-info.jpg"/>" alt="">
            <div class="rice-info-center"> 세계 각국의 다양한 덮밥요리를 맛볼 수 있습니다. (1인 기준 280~300g 내외)</div>
        </div>
      </div>
      <div class="rice-box-container">
        <div class="rice-box-wrapper">
