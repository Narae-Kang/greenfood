...
<div class="aaa">
  ...
  action="${pageContext.request.contextPath }/order/oneOrder">
  <h2>장바구니 > <b style="color: rgb(188, 224, 116);">주문서 작성/결제</b> > 식단고르기</h2>
    ...
    <a id="shopping_cancle_btn" href="${pageContext.request.contextPath }">취소</a>
    <button type="submit" id="shopping_buy_btn">결제</button>
    </div>
