	...
	<div class="content">
		<div class="contents-inner">
			<div class="section m2">
				<div class="section">
					<div class="title">
						<h2 class="write">식단 등록</h2>
					</div>
				</div>
				<form:form action="${pageContext.request.contextPath }/admin/adminMenuWrite/${returnPage }"
							...
							<table>
								...
								<tbody>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="date" id="mdate" path="mdate" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="menu" path="menu" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="cal" path="cal" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="maindish" path="maindish" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="rice" path="rice" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="side1" path="side1" />
												<div>
													<span class="errmsg" id="title_errmsg"></span>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="side2" path="side2" />
												<div>
													<span class="errmsg" id="title_errmsg"></span>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="side3" path="side3" />
												<div>
													<span class="errmsg" id="title_errmsg"></span>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="side_side" path="side_side" />
												<div>
													<span class="errmsg" id="title_errmsg"></span>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="soup" path="soup" />
												<div>
 									...
 									<tr>
										...
										<td>
											<div class="textfield">
												<form:input type="text" id="salad" path="salad" />
												<div>
													<span class="errmsg" id="title_errmsg"></span>
					...
					<div class="textfield">
						<div class="tailfield">
							<button type="submit" class="tail" id="writeBtn" data-returnPage="${returnPage }" data-mnum="${menuVO.mnum }">등록</button>
